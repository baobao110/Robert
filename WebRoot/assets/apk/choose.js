...
function createOneModalHtml(data) {
	...
	html+='<div class="layui-input-block" id="apk">';
	/*if(audio != null){
	...
	html+='<center><button class="layui-btn layui-btn-primary layui-btn-sm ump3"  onclick="uploadmy_show(this);">选择apk文件</button></div><div>';
